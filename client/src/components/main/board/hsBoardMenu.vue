    ...
    transition(name="pocket-transition")
      div(
        ...
        div(class="board-menu__pocket__elements")
          div(
            v-for="element in configBoardMenu.elements"
            :key="element.text.title"
            class="board-menu__pocket__elements__element"
            @click="sendActionBM(element.key)")
            icon(
              :name="element.icon"
    ...
    transition(name="main-transition")
      div(
        ...
        div(
          v-for="element in configBoardMenu.elements"
          :key="element.key"
          :class="{'board-menu__main__element--hover-move': checkChildren(element)}"
          ...
          div(class="board-menu__main__element__text")
            div(class="board-menu__main__element__text__title") {{element.text.title}}
            div(
              v-if="checkChildren(element)"
              class="board-menu__main__element__text__children")
              div(class="board-menu__main__element__text__children__circle")
                div(
                  v-text="children(element)"
                  class="board-menu__main__element__text__children__circle__number")
            div(class="board-menu__main__element__text__description") {{element.text.description}}
...
export default {
  ...
  methods: {
    checkChildren (element) {
      ...
      if (typeof (element.children) === 'object') res = true
