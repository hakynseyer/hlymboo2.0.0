<template lang="pug">
  div(class="header__links")
    div(
      ...
      v-for="link in lang.hsHeaderLeft.links.logoutLinks")
      router-link(
    ...
    div(
      v-if="$store.state.login"
      v-for="link in lang.hsHeaderLeft.links.loginLinks")
      router-link(
        :to="{name: link.page}"
        class="header__links__link") {{link.name}}

    div(v-for="link in lang.hsHeaderLeft.links.allwaysLinks")
      router-link(
        :to="{name: link.page}"
        class="header__links__link") {{link.name}}
    //- button(
...
export default {
  mixins: [components('hsHeaderLeft')],
